function ExtractCdp_AF_v0(fname,varargin)
...
if ~isempty(find((RTLS_data(:,1)==0 & RTLS_data(:,2)==tags_SN(1))))
    save(strcat(parent_path, '/extracted_', fn, '.mat'),'tag_data','sync_data','CDPmtdata','tag_data_filt','tag_ac_data', 'TTL_network_times');
else
    save(strcat(parent_path, '/extracted_', fn, '.mat'),'tag_data','sync_data','CDPmtdata','tag_data_filt');
end
