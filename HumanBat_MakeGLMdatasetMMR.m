% Make dataset for Mixed Multiple Regression 
...
table_{nn} = [E_cat,B_cat,B_other_cat,K_cat,M_cat,C_cat,P_cat,D_cat,PO_cat,ID_cat];
...
table1=[];
for i=1:length(table_)
    table1 = [table1;table_{i}];
end
save(strcat(exp_data_path,'GLM/training/',num2str(batdate),'_14650_dataset2_allFlights_MMR_.mat'),'table1','-v7.3');
