function [] = HumanBat_audio_concat(filePath)
    ...
    for mic_i = 1:4
        ...
        fileFirst_pre = dir([filePath '*_' Date '_audio_trial_' num2str(firstFileIdx) '.mat']);
        fileFirst = load(fileFirst_pre.name);
        ...
        for file_i = firstFileIdx:lastFileNum-1
            ...
            fileNext_Pre = dir([filePath '*_' Date '_audio_trial_' num2str(file_i+1) '.mat']);
            fileNext = load(fileNext_Pre.name);
