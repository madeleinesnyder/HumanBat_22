function [echolocation_idxs,echolocation_vector_DS] = HumanBat_extract_echolocations(audioConCat)
...
%     
%     % Filter the raw signal withbandpass and see how the different filters look:
