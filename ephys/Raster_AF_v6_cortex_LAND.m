function [PSTH_mn,PSTH_cs,PSTH_up,PSTH_dn] = Raster_AF_v6_cortex_LAND(s,pts1,pts2,ids1,ids2,clrs1,clrs2,interval,cv1,cv2,ptitle1,ptitle2,PSTH_flag,fig_flag,Mx_flights,Kx_flights,cortex_flight_struct_resort,clus)
...
if fig_flag
    ...
    M_cols = [0 0 1 ; 0.2 0.2 1; 0.3 0.3 1; 0.4 0.4 1; 0.5 0.5 1; 1 0.55 0.55; 1 0.6 0.6; 1 0.65 0.65; 1 0.7 0.7; 1 0.75 0.75; 1 0.8 0.8; 1 0.85 0.85; 1 0.9 0.9];
