% Script to examine the SI for each neuron (extrapolated from Nick's paper)
...
if exist(strcat(exp_data_path,'ephys/logger13/extracted_data/unit_',num2str(unit),'_shuffles/shuffle_SI.mat'))
    shuffles = load(strcat(exp_data_path,'ephys/logger13/extracted_data/unit_',num2str(unit),'_shuffles/shuffle_SI.mat'));
