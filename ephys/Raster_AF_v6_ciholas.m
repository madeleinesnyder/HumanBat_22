function [PSTH_mn,PSTH_cs,PSTH_up,PSTH_dn] = Raster_AF_v6_ciholas(s,pts1,pts2,ends1,ends2,ids1,ids2,clrs1,clrs2,interval,cv1,cv2,ptitle1,ptitle2,PSTH_flag,fig_flag,Mx_flights,Kx_flights,ciholas_flight_struct_resort,clus)
...
% Get the cyan bars for the end of the flight
